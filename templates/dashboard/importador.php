...
<div id="scl-importer-step-1">
	<div class="scl-page-header">
		<h1 class="scl-page-title"><?php esc_html_e( 'Importar Partidos desde CSV', 'sportcriss-lite' ); ?></h1>
		<a href="<?php echo esc_url( $plantilla_url ); ?>" class="scl-btn scl-btn--secondary">
			<?php esc_html_e( '↓ Descargar plantilla', 'sportcriss-lite' ); ?>
		</a>
	</div>

	<div class="scl-form-section">
		<p class="scl-description">
			<?php esc_html_e( 'Sube un archivo CSV con tus partidos. El torneo debe existir previamente. Los equipos, temporadas, jornadas y grupos inexistentes se crean automáticamente.', 'sportcriss-lite' ); ?>
		</p>
		...
		<div id="scl-csv-dropzone" class="scl-dropzone" role="button" tabindex="0">
			...
			<p class="scl-dropzone__hint">
				...
				printf(
					...
					esc_html__( 'Máximo %d filas · Solo archivos .csv', 'sportcriss-lite' ),
					(int) $max_filas
				);
				?>
			</p>
...
<div id="scl-importer-step-2" style="display:none;">
	<div class="scl-page-header">
		<h1 class="scl-page-title"><?php esc_html_e( 'Validación del CSV', 'sportcriss-lite' ); ?></h1>
	</div>

	<div class="scl-form-section">
		<div class="scl-cards-row scl-cards-row--compact">
			<div class="scl-card">
				<div class="scl-card__value" id="scl-val-total">0</div>
				<div class="scl-card__label"><?php esc_html_e( 'Total de filas', 'sportcriss-lite' ); ?></div>
			</div>
			<div class="scl-card scl-card--ok">
				<div class="scl-card__value" id="scl-val-validas">0</div>
				<div class="scl-card__label"><?php esc_html_e( 'Filas válidas', 'sportcriss-lite' ); ?></div>
			</div>
			<div class="scl-card scl-card--warn">
				<div class="scl-card__value" id="scl-val-errores">0</div>
				<div class="scl-card__label"><?php esc_html_e( 'Filas con error', 'sportcriss-lite' ); ?></div>
			</div>
		</div>
	...
	<div class="scl-form-section">
		...
		<div class="scl-form-actions" style="margin-top:1.5rem;">
			<button type="button" id="scl-cambiar-archivo" class="scl-btn scl-btn--outline">
				← <?php esc_html_e( 'Cambiar archivo', 'sportcriss-lite' ); ?>
			</button>
			<button type="button" id="scl-importar-btn" class="scl-btn scl-btn--primary">
				<?php esc_html_e( 'Importar partidos', 'sportcriss-lite' ); ?>
			</button>
		</div>
	</div>
</div>
...
<div id="scl-importer-step-3" style="display:none;">
	<div class="scl-page-header">
		<h1 class="scl-page-title"><?php esc_html_e( 'Importación completada', 'sportcriss-lite' ); ?></h1>
	</div>
	...
	<div class="scl-form-section scl-importer-resultado">
		...
		<div class="scl-cards-row scl-cards-row--compact">
			<div class="scl-card scl-card--ok">
				<div class="scl-card__value" id="scl-res-creados">0</div>
				<div class="scl-card__label"><?php esc_html_e( 'Partidos creados', 'sportcriss-lite' ); ?></div>
			</div>
			<div class="scl-card">
				<div class="scl-card__value" id="scl-res-omitidos">0</div>
				<div class="scl-card__label"><?php esc_html_e( 'Filas omitidas', 'sportcriss-lite' ); ?></div>
			</div>
		</div>
		...
		<div class="scl-form-actions" style="margin-top:1.5rem;">
			...
			<button type="button" id="scl-otro-csv" class="scl-btn scl-btn--outline">
				<?php esc_html_e( 'Importar otro CSV', 'sportcriss-lite' ); ?>
			</button>
		</div>
	</div>
</div>
