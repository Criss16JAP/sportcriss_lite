...
class Scl_Dashboard {
	...
	public function encolar_assets() {
		...
		if ( 'estadisticas_partido' === $ruta ) {
			wp_enqueue_script(
				'scl-estadisticas-js',
				SCL_URL . 'assets/js/estadisticas.js',
				[ 'jquery', 'scl-dashboard-js' ],
				SCL_VERSION,
				true
			);
	...
	private function dispatch( string $ruta, int $id, string $accion ): void {
		...
		$templates = [
			...
			'jugadores'             => 'dashboard/jugadores-lista.php',
			'inscripciones'         => 'dashboard/inscripciones.php',
		...
		<nav class="scl-nav">
			<div class="scl-nav__inner">
				...
				<ul class="scl-nav__links" id="scl_nav_links">
					...
					<li class="scl-nav__group">
						<button class="scl-nav__group-btn"><?php esc_html_e( 'Torneos', 'sportcriss-lite' ); ?> &#9660;</button>
						<ul class="scl-nav__dropdown">
					...
					<li class="scl-nav__group">
						<button class="scl-nav__group-btn"><?php esc_html_e( 'Datos', 'sportcriss-lite' ); ?> &#9660;</button>
						<ul class="scl-nav__dropdown">
					...
					<li class="scl-nav__group">
						<button class="scl-nav__group-btn"><?php esc_html_e( 'Operaciones', 'sportcriss-lite' ); ?> &#9660;</button>
						<ul class="scl-nav__dropdown">
					...
					<li class="scl-nav__group">
						<button class="scl-nav__group-btn"><?php esc_html_e( 'Cuenta', 'sportcriss-lite' ); ?> &#9660;</button>
						<ul class="scl-nav__dropdown">
